package com.example.myapplicationscs
...
fun Play(modifier: Modifier = Modifier) {
    Column(
        ...
        Text(text = "Imam Dwi Yan Permana", Modifier.padding(start = 15.dp))
        MainSection(
            judulParam = "nama", isiParam = "Muhammad Faris Abqari"
        )
        MainSection(
            judulParam = "Kelas", isiParam = "B"
        )
        MainSection(
            judulParam = "NIM", isiParam = "20220140097"
        )
        MainSection(
            judulParam = "Keterangan", isiParam = "Asik"
        )
    }
}
